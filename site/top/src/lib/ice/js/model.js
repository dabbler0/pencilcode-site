(function() {
  ...
  define(['ice-view'], function(view) {
    var Block, BlockEndToken, BlockStartToken, CursorToken, Indent, IndentEndToken, IndentStartToken, NewlineToken, Segment, SegmentEndToken, SegmentStartToken, Socket, SocketEndToken, SocketStartToken, TextToken, Token, cloneTokens, exports, lengthBetween;
    exports = {};
    exports.cloneTokens = cloneTokens = function(start, end) {
      var beginning, block_clone, clonedEnd, clonedStart, cursor, head;
      head = start;
    ...
    lengthBetween = function(start, end) {
      var head, len;
      head = start;
      len = 1;
      while (head !== end) {
    ...
    exports.Block = Block = (function() {
      function Block(precedence, color) {
      ...
      Block.prototype.clone = function() {
        var clone, clonedEnd, clonedStart, _ref;
        clone = new Block(this.precedence, this.color);
        if (this.start.next !== this.end) {
          _ref = cloneTokens(this.start.next, this.end.prev), clonedStart = _ref[0], clonedEnd = _ref[1];
      ...
      Block.prototype.length = function() {
        return lengthBetween(this.start, this.end);
      };
    ...
    exports.Segment = Segment = (function() {
      ...
      Segment.prototype.getTokenAtLocation = function(location) {
        var head, _i, _ref, _ref1;
        if (location == null) {
          return null;
        }
        head = this.start;
        for (_i = 1; 1 <= location ? _i <= location : _i >= location; 1 <= location ? _i++ : _i--) {
          while ((_ref = head.type) === 'segmentStart' || _ref === 'segmentEnd' || _ref === 'cursor') {
            head = head.next;
          }
          head = head.next;
        }
        while ((_ref1 = head.type) === 'segmentStart' || _ref1 === 'segmentEnd' || _ref1 === 'cursor') {
          head = head.next;
        }
        return head;
      };
    ...
    exports.Token = Token = (function() {
      ...
      Token.prototype.getSerializedLocation = function() {
        ...
        count = 0;
        while (head !== null) {
          if ((_ref = head.type) !== 'cursor' && _ref !== 'segmentStart' && _ref !== 'segmentEnd') {
            count += 1;
          }
          head = head.prev;
        }
